...
"use strict";$("button#form-btn").click(function(){event.preventDefault(),$("#email").val().length<3||$("#message").val().length<10?$("#form-error").text("Please fill both fields."):$("#contact-form").submit()});
"use strict";!function(t){t('a.js-scroll-trigger[href*="#"]:not([href="#"])').click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var e=t(this.hash);if((e=e.length?e:t("[name="+this.hash.slice(1)+"]")).length)return t("html, body").animate({scrollTop:e.offset().top-56},400),!1}}),t(".js-scroll-trigger").click(function(){t(".navbar-collapse").collapse("hide")}),t("body").scrollspy({target:"#main-nav",offset:56})}(jQuery);